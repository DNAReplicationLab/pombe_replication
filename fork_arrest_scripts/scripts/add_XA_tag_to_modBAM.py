import sys
from DNAscentTools.modBAM_tools_additional import modBAM_add_XA_tag, HeaderLines


if __name__ == "__main__":

    desc = """    Add an XA tag to the end of every .mod.bam line.
    ...
    Sample usage:
        samtools view -h sample.mod.bam | python add_XA_tag_to_modBAM.py
    """
    ...
    header = HeaderLines("add_XA_tag_to_modBAM.py", "1.0.0")
    ...
    for line in sys.stdin:
        if line.startswith("@"):
            ...
            # add an XA tag and print modBAM line
            print(modBAM_add_XA_tag(line), end="")
