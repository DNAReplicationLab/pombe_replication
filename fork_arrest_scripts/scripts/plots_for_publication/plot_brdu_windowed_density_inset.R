...
r <- ggplot(tbl, aes(x = x, y = mean_brdU_count)) +
      ...
      scale_x_continuous(expand = c(0.012, 0.012), limits = c(0, 1.1), breaks = seq(0, 1, 0.5)) +
      scale_y_continuous(expand = c(0.012, 0.012), limits = c(0, 0.5), breaks = seq(0, 0.5, 0.25)) +
      theme_classic(base_size = 70) +
      theme(axis.text = element_text(colour = "black"), axis.title.x = element_blank(), axis.title.y = element_blank())
