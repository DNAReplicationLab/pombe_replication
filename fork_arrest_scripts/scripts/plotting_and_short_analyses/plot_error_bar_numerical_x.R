...
# goal of program
# ===============
# Given mean, sd and a numerical x label (not categorical), plot data with error bars.
...
# =============================
# let's say we have done measurements of height on many kinds of cats binning them by weight.
# and want to plot cat height mean +- sd on y axis, and weight on x axis.
# < /path/to/cat/height.tsv Rscript <script_name>.R /path/to/cat/height.png "Cat weight" "Cat height (in)"
